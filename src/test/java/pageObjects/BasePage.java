...
public class BasePage extends DriverLoader {
    ...
    public String waiteForePageTitle(){
        try {
            ...
            System.out.println("Unable to locate (get) the current Page title:  "+ e.getMessage());
            return e.getMessage();
        }
    }
    ...
    public boolean isDisplay(WebElement element) {
        try {
            ...
            System.out.println("Test case failed due to element is not displaying::  " + exception);
            return false;
        }
    }
    ...
    public void selectDropDownVisibleText(WebElement element, String value){
        try{
            Select select = new Select(element);
